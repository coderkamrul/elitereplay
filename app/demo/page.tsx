...
export default function DemoPage() {
  ...
  const simulateQRScan = () => {
    ...
    setTimeout(() => {
      window.open("/start?court=ABC123", "_blank")
    }, 1500)
  }
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <footer className="py-12 border-t border-gray-800 mt-16">
        <div className="container mx-auto px-4 text-center">
          ...
          />
          <p className="text-gray-400 mb-8">Experience the future of sports highlights</p>
          <div className="flex justify-center gap-8">
            <Link href="/" className="text-gray-400 hover:text-[#F5BE2D] transition-colors">
              Home
            </Link>
            <Link href="/technology" className="text-gray-400 hover:text-[#F5BE2D] transition-colors">
              Technology
            </Link>
            <Link href="/contact" className="text-gray-400 hover:text-[#F5BE2D] transition-colors">
              Contact
            </Link>
          </div>
          <p className="text-gray-500 mt-8">© {new Date().getFullYear()} ÉliteReplay. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
