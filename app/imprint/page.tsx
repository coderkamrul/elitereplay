        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0 text-center md:text-left">
              ...
              />
              <p className="text-gray-400">AI-powered sports highlights</p>
            </div>
            <div className="flex flex-col sm:flex-row gap-6 text-center">
              ...
              <Link href="/imprint" className="text-[#F5BE2D] font-medium">
                Imprint
              </Link>
              <Link href="/privacy" className="text-gray-400 hover:text-[#F5BE2D] transition-colors">
                Privacy
              </Link>
            </div>
          </div>
