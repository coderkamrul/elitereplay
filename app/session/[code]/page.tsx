    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <footer className="py-12 border-t border-gray-800 mt-16">
        <div className="container mx-auto px-4 text-center">
          ...
          />
          <p className="text-gray-400 mb-8 text-lg">AI-powered sports highlights delivered instantly</p>
          <div className="flex justify-center gap-8 mb-8">
            <Link href="/" className="text-gray-400 hover:text-[#F5BE2D] transition-colors text-lg">
              Home
            </Link>
            <Link href="/technology" className="text-gray-400 hover:text-[#F5BE2D] transition-colors text-lg">
              Technology
            </Link>
            <Link href="/contact" className="text-gray-400 hover:text-[#F5BE2D] transition-colors text-lg">
              Contact
            </Link>
            <Link href="/privacy" className="text-gray-400 hover:text-[#F5BE2D] transition-colors text-lg">
              Privacy
            </Link>
            <Link href="/imprint" className="text-gray-400 hover:text-[#F5BE2D] transition-colors text-lg">
              Imprint
            </Link>
          </div>
          <p className="text-gray-500">© {new Date().getFullYear()} ÉliteReplay. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
